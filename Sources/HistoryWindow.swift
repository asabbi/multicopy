...
class HistoryWindow: NSWindowController {
    ...
    private func selectCurrentItem() {
        ...
        // Restore focus to the originating application before pasting
        if let originatingApp = originatingApp {
            originatingApp.activate(options: .activateIgnoringOtherApps)
            
            // Wait briefly for focus to be restored
